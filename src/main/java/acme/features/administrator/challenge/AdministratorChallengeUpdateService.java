...
public class AdministratorChallengeUpdateService implements AbstractUpdateService<Administrator, Challenge> {
	...
	public Challenge findOne(final Request<Challenge> request) {
		...
		Challenge result = this.repository.findChallengeById(request.getModel().getInteger("id"));
	...
	public void validate(final Request<Challenge> request, final Challenge entity, final Errors errors) {
		...
		Challenge dbChallenge = this.repository.findChallengeById(entity.getId());
		...
		if (!errors.hasErrors("deadline") && !dbChallenge.getDeadline().equals(entity.getDeadline())) {
